...
@router.callback_query(F.data == "stat_day")
...
@router.callback_query(F.data.startswith("stat_nav:"))
...
@router.callback_query(PeriodState.waiting_for_start, F.data.startswith("st1_nav:"))
...
@router.callback_query(PeriodState.waiting_for_start, F.data.startswith("st1_day:"))
...
@router.callback_query(PeriodState.waiting_for_end, F.data.startswith("st2_nav:"))
...
@router.callback_query(PeriodState.waiting_for_end, F.data.startswith("st2_day:"))
...
@router.callback_query(F.data.in_({"stat_ignore", "st1_ignore", "st2_ignore"}))
async def ignore_all(callback: types.CallbackQuery):
    await callback.answer()

@router.callback_query(F.data.in_({"stat_cancel", "st1_cancel", "st2_cancel"}))
...
@router.callback_query(F.data == "stat_back_menu")
